...
import GroupUserPanel from "./GroupUserPanel";
...
export default function GroupDetails(props) {
  ...
  return (
    ...
    >
      ...
      >
        <NavLink to="/user-management/groups" className="link-default">
        <Text
          fontFamily="Inter"
          fontSize="16px"
          fontWeight="200"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Back to Group Management"
      ...
      ></Divider>
      { activeTab === 0 && (<GroupUserPanel groupName={groupName} />) }
    </Flex>
  );
}
