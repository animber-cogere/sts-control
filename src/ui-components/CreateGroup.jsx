...
import { createGroup } from "../utils/helper"
...
export default function CreateGroup(props) {
  ...
  const onCreateGroup = () => {
    createGroup(groupName, props.onClose);
  }
  ...
  return (
    ...
    <Flex
      ...
      {...getOverrideProps(overrides, "CreateGroup")}
      {...rest}
    >
      <Flex
        gap="10px"
      ...
      >
        ...
        >
          <Text
            ...
            {...getOverrideProps(overrides, "Create Group")}
          ></Text>
          <View
            width="24px"
            height="24px"
      ...
      >
        ...
        >
          <Button
            ...
            variation="default"
            children="Cancel"
            {...getOverrideProps(overrides, "Button2622162")}
          ></Button>
          <Button
            ...
            variation="primary"
            children="Create Group"
            {...getOverrideProps(overrides, "Button2622163")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
