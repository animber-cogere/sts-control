...
import { getEmailForUser } from "../utils/helper";

export default function UserDevicePanel(props) {
  ...
  useEffect(() => {
    searchDevices(search, userName, setPageNum, setFiltered);
    setCheckedCount(0);
  }, [search, renderFlip])
  ...
  return (
    <>
      ...
      { showModal && <AddUserDevice userName={userName} onClose={onClose} /> }
    </>
  );
}