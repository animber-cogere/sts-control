...
import { getUsersForDevice, addUsersForDevice } from "../utils/helper"
import "./styles.css"

export default function AddDeviceUser(props) {
  ...
  useEffect(() => {
    getUsersForDevice(devId, setUsers);
  }, []);
  ...
  const onAddUser = () => {
    addUsersForDevice(devId, selUsers, props.onClose);
  }
